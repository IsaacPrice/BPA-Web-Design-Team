...
[
    ...
    {
        name: 'Mattias Niebbia',
        role: 'Drummer',
        age: 17,
        images: ['MattiasNiebbia/1', 'MattiasNiebbia/2', 'MattiasNiebbia/3'],
        bio: "Once shy, now unstoppable. Mattias’ beats keep the heart of Stage Fright pumping."
    },
    {
        name: 'Clark Meridew',
        role: 'Guitarist',
